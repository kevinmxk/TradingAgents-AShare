...
export default function DebateDrawer({ debate, onClose }: DebateDrawerProps) {
    ...
    return (
        <>
            ...
            {/* Drawer */}
            <div className="fixed right-0 top-0 z-50 flex h-full w-full flex-col border-l border-slate-700 bg-slate-900 shadow-2xl animate-in slide-in-from-right duration-300 dark sm:min-w-[400px] lg:w-1/2 lg:max-w-[720px]">
                {/* Header */}
